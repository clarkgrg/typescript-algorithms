...
class VarDecl extends AST {
  private var_node: Var;
  private var_type: Type;
  constructor(var_node: Var, var_type: Type) {
    super();
  ...
  public showType() {
    console.log(
      `VarDecl { var_node: ${this.var_node.getShortName()}, var_type: ${this.var_type.getShortName()}}`
    );
  }
}
